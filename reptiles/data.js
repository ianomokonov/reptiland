...
<br/><br/>
  ...
  },
  {
    ...
    fullDescription: {
      ...
      tailColor: '#FFC700',
      bodyColor: '#FF8D27',
      areaDescription: `Эти гекконы ведут ночной образ жизни. Обитают на каменистых предгорьях и полузакреплённых песках на северо-западе Индии, в Пакистане, на юго-востоке Афганистана, на востоке Ирана.
      <br/><br/>
      Пятнистые эублефары — жители полупустынь и засушливых степей (саванн). Их среда обитания — песчано-каменистая почва, каменные россыпи, тяжелые глинистые почвы. Растительность представлена из засухоустойчивых кустарников и трав. 
      <br/><br/>
      На родине леопардовых гекконов вода и еда может быть недоступна в течении нескольких месяцев, а температура колеблется от 5-15ºC зимой и до 40ºC и более летом. Из-за низкой температуры в зимнее время животные впадают в полу-спячку. Это не состояние анабиоза, а некая «зимовка», в течении которой спрятавшиеся под землей в укрытиях и норах гекконы пережидают холодное время года, живя за счёт жировых запасов, хранилищем которых выступает хвост ящерицы.`,
  ...
  },
  {
    ...
    fullDescription: {
      ...
      tailColor: '#FFC700',
      bodyColor: '#FF8D27',
      areaDescription: `Обитает реснитчатый бананоед в лесах с повышенной влажностью — тропиках. Образ жизни ведет в основном древесный. На землю спускается очень редко. Данный вид считали давно вымершим, пока его вновь не обнаружили в 1994 году на территории Новой Каледонии. 
      <br/><br/>
      Большие популяции рептилий заселяют материковые территории с тропическим и субтропическим климатом, включая океанические острова, по всему миру.  Встретить необычных пресмыкающихся можно в засушливых местах, жарких пустынях Африки, джунглях Австралии, в юго-западной части Америки. В нашей стране ящерица геккон обитает в лесных районах и горных массивах Кавказа, полуострова Крым. 
      <br/><br/>
      Многие ящерицы предпочитают высокоствольные деревья, скалистые поверхности, склоны над водоемами, каменистые пещеры.`,
      ...
      food: {
        descriptions: [
          `В природе бананоеды питаются насекомыми и перезрелыми фруктами. В домашних условиях их кормят насекомыми и фруктовым пюре.`,
          `Кормить:<br/>
          —с 1-6м <b>каждый или через день</b>;<br>
          — с 6-12м	<b>через два дня</b>;<br/>
          — от 12м	<b>1-2 раза в неделю</b>.`,
